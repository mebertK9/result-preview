saison_25_26 = [
    ...
    ("Fitness First Würzburg Baskets", "Bayern München", 81, 90),
    ("Veolia Towers Hamburg", "Rostock Seawolves", 91, 86),
    ("Bayern München", "Rostock Seawolves", 86, 64),
    ("Bayern München", "Alba Berlin", 85, 79),
    ...
    ("ratiopharm Ulm", "Veolia Towers Hamburg", 81, 72),
    ("MHP RIESEN Ludwigsburg", "Rostock Seawolves", 75, 61),
    ("Science City Jena", "VET-CONCEPT Gladiators Trier", 102, 94),
    ("EWE Baskets Oldenburg", "MLP Academics Heidelberg", 94, 74),
    ("SYNTAINICS MBC", "Fitness First Würzburg Baskets", 83, 52),
    ("Skyliners Frankfurt", "Alba Berlin", 61, 87),
    ("Chemnitz 99ers", "BMA365 Bamberg Baskets", 62, 89),
    ("Skyliners Frankfurt", "Telekom Baskets Bonn", 72, 104),
    ("Fitness First Würzburg Baskets", "ratiopharm Ulm", 98, 84),
    ("Rostock Seawolves", "Science City Jena", 89, 79),
    ("VET-CONCEPT Gladiators Trier", "EWE Baskets Oldenburg", 95, 98),
    ("BB Löwen Braunschweig", "MHP RIESEN Ludwigsburg", 98, 97),
